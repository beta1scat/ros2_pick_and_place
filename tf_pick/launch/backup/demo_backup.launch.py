...
def generate_launch_description():
    ...
    rviz_base = os.path.join(get_package_share_directory("tf_resources_ur_moveit_config"), "launch")
    rviz_full_config = os.path.join(rviz_base, "ur_moveit_config_demo.rviz")
    rviz_empty_config = os.path.join(rviz_base, "ur_moveit_config_demo_empty.rviz")
