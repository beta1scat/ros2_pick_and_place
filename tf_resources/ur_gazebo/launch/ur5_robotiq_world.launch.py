...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
        ...
        # launch_arguments={'paused': True},
    )
    
    # rrbot_description_path = os.path.join(get_package_share_directory('tf_resources_ur_description'))

    # xacro_file = os.path.join(rrbot_description_path,'urdf','ur5_robot.urdf.xacro')
    ...
    return LaunchDescription([
      ...
      RegisterEventHandler(
          event_handler=OnProcessExit(
              ...
              on_exit=[load_joint_trajectory_controller2],
          )
      ),
      gazebo,
